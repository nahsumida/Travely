...
fun makeBookingRequest() {
    val client = BookingManagerClient()
    CoroutineScope(Dispatchers.Main).launch {
        val response = client.sendBookingRequest(
            authID = "grAvCnSRzOOSi814teqiBo7F00C2",
            placeID = "BDxWmMnb099UedcmlzeW",
            datetime = "2024-11-12T09:00:00Z",
            amount = 1
        )
